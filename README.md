...
<div align="center">
  ...
  <img src="todolist-logo.png" alt="logo" width="140"  height="auto" />
  <br/>
...
This website will give user the tool that can task management.
...
```bash
git clone https://github.com/hienphan/To-do-list.git
```
